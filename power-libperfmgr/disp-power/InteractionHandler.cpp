...
static const bool kDisplayIdleSupport =
        ::android::base::GetBoolProperty("vendor.cannon.powerhal.disp.idle_support", true);
...
static const uint32_t kWaitMs =
        ::android::base::GetUintProperty("vendor.cannon.powerhal.disp.idle_wait", /*default*/ 100U);
static const uint32_t kMinDurationMs =
        ::android::base::GetUintProperty("vendor.cannon.powerhal.interaction.min", /*default*/ 1400U);
static const uint32_t kMaxDurationMs =
        ::android::base::GetUintProperty("vendor.cannon.powerhal.interaction.max", /*default*/ 5650U);
static const uint32_t kDurationOffsetMs =
        ::android::base::GetUintProperty("vendor.cannon.powerhal.interaction.offset", /*default*/ 650U);
